...
var loadLibrary = function() {
  ...
  if (!loader && !window.amp) {
    loader = new Promise(function(resolve, reject) {
      ...
      linkTag.href =
        '//amp.azure.net/libs/amp/2.3.5/skins/' +
        skin +
...
var AzureMP = (function(_Component) {
  ...
  function AzureMP(props) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (AzureMP.__proto__ || Object.getPrototypeOf(AzureMP)).call(this, props)
    )
    ...
    },
    {
      ...
      value: function createPlayer() {
        var _props2 = this.props,
          ...
          onInstanceCreated = _props2.onInstanceCreated
    ...
    },
    {
      ...
      value: function render() {
        var _props3 = this.props,
          ...
          _props3$skin = _props3.skin,
          skin = _props3$skin === undefined ? DEFAULT_SKIN : _props3$skin,
          _props3$adaptRatio = _props3.adaptRatio,
          adaptRatio =
            _props3$adaptRatio === undefined
              ? DEFAULT_RATIO
              : _props3$adaptRatio,
          cornerPlayBtn = _props3.cornerPlayBtn
        ...
        return React.createElement(
          'div',
          {
            ...
            className: classnames(
              defineProperty({}, styles['azure-mp-container'], adaptRatio),
              className
            )
          },
